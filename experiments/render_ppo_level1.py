"""
Render trained PPO Level 1 model and create animated visualization.
...
def create_animation(frames, metrics, save_path):
    ...
    ax_video.set_title('PPO Level 1 Controller - Real-time Visualization', fontsize=14, fontweight='bold')
    ax_video.axis('off')
