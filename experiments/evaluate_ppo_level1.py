"""
Evaluate trained PPO Level 1 model and generate plots.
Tests the model on ±3° perturbations and visualizes performance.
"""
...
def plot_results(stats, save_dir):
    ...
    plt.tight_layout()
    summary_path = os.path.join(save_dir, 'level1_evaluation.png')
...
if __name__ == '__main__':
    ...
    model_path = os.path.join(project_root, 'results/ppo_level1/ppo_level1_final')
