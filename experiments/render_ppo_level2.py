...
def main():
    ...
    print("\n" + "="*60)
    print("PPO Level 2 Controller - Rendering Visualization")
    print("="*60)
    print("\nTask: Stabilize double inverted pendulum on cart")
    print("Level 2: ±10° initial perturbations")
    ...
    # Level 2: ±10°, so test with +8.5° and -8.5°
    print("\nRendering episode with challenging initial perturbation...")
    print("Testing: θ₁ = +8.5°, θ₂ = -8.5° (near boundary of ±10°)")
    frames, metrics = render_episode(model, env, max_steps=1000,
                                     initial_angles=(8.5, -8.5))

    env.close()

    # Create animation
    save_path = f"{save_dir}/level2_animation.gif"
